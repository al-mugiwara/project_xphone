	...
	<div class="page-content">
		...
		<div class="content-wrapper">
			...
			<div class="content d-flex justify-content-center align-items-center">
				...
				<!-- Login card -->
				<form class="login-form" action="<?=base_url('Welcome');?>" method="POST">
					<div class="card mb-0">
						<div class="card-body">
							<div class="text-center mb-3">
								<i class="icon-people icon-2x text-warning-400 border-warning-400 border-3 rounded-round p-3 mb-3 mt-1"></i>
								<h5 class="mb-0">Login Administartor X Phone</h5>
							...
							<div class="form-group d-flex align-items-center">
								...
								<a href="<?=base_url();?>login_password_recover.html" class="ml-auto">Forgot password?</a>
							</div>
							...
							<span class="form-text text-center text-muted">By continuing, you're confirming that you've read our <a href="<?=base_url();?>#">Terms &amp; Conditions</a> and <a href="<?=base_url();?>#">Cookie Policy</a></span>
						</div>
					</div>
				</form>
				<!-- /login card -->
